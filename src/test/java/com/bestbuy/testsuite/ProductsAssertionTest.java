...
public class ProductsAssertionTest extends TestBase {
    ...
    @Test
    public void verifyNameInArrayList() {
    ...
    @Test
    public void verifyNamesInArrayList() {
    ...
    @Test
    public void verifyProductIdHousewares() {
    ...
    @Test
    public void verifyProductIdEquals() {
        response.body("data[8].id", equalTo(333179));
    }

    //20. Verify the prodctId = 346575 have 5 categories
    @Test
    public void verifyProductIdCategories() {
        response.body("data[9].id", equalTo(346575))
                .body("data[9].categories.size",equalTo(5));
    }
}
